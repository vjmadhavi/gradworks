print("Presented by:\n Jakkampudi Venu Madhavi(101103662)\n Anisha Pathakamoodi(101101639)\n Chandana Korrapati(101073424) ")
...
while True:
    try:
        ...
        # prints invalid errors
        print(Fore.RED+ "Invalid input"+Fore.RESET)

while True:
    try:
        # input for size of the grid
...
while True:
    try:
        sml=int(input("Enter number of simulations: "))#input for of number simulations
        if sml<0:
...
def scatter_plot(board, dim, sml):
    ...
    #x=sml/time_diff
    print("number of frames per second", sml/p)
